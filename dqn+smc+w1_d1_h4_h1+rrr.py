...
plt.plot(logs_df["episode"].values, logs_df["val_return"].values, label="Validation Return")
...
plt.figure(figsize=(12, 5))
plt.plot(logs_df["episode"].values, logs_df["epsilon"].values, label="Epsilon")
...
plt.figure(figsize=(12, 5))
plt.plot(logs_df["episode"].values, logs_df["avg_loss"].values, label="Average Loss")
...
plt.figure(figsize=(12, 5))
plt.plot(equity_df["portfolio_value"].values, label="Portfolio Value")
...
plt.figure(figsize=(12, 5))
plt.plot(equity_df["drawdown"].values, label="Drawdown")
...
plt.figure(figsize=(12, 5))
plt.plot(actions_df["target_ratio"].values, label="Target Position Ratio")
...
plt.figure(figsize=(12, 5))
plt.plot(equity_df["mtf_confluence_score"].values, label="MTF Confluence Score")
